    ...
    public void onEdit(MouseEvent mouseEvent) {
        ...
        if (Time.valueOf(horaireDebut).before(Time.valueOf(horaireFin))) {
            try {
                ...
                Tournee tournee = new Tournee(tourneeId, datePicker.getValue(), horaireDebut, horaireFin, Producteur.producteurDAO.getByAccountId(App.userConnected.getId()).getNumSiret(), vehicule.getNumImmat());
