...
import static org.junit.jupiter.api.Assertions.*;
    class ArticleTest {
        ...
        public void testConstructor() {
            Article a = new Article(1,"name", "categorie", "description", 10.0, 5.0, 123, (long)11122233344456.0);
            ...
            assertEquals((long)11122233344456.0, a.getNumSiret());
        }
        ...
        public void testSetNumSiret() {
            Article a = new Article(1,"name", "categorie", "description", 10.0, 5.0, 123, (long)11122233344456.0);
            a.setNumSiret((long)11122233344456.0);
            assertEquals((long)11122233344456.0, a.getNumSiret());
        }
